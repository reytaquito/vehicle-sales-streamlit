...
description = '''Vehicle Sales Analysis is an interactive Streamlit web application that allows users to explore and analyze used car listings. The app includes features such as dynamic data visualizations, customizable filters by condition, and car comparisons. It provides an intuitive way to gain insights into vehicle pricing trends and market behavior.'''
